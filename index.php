...
if ($faqConfig->get('main.enableRewriteRules')) {
    $tplNavigation = array(
        ...
        'phpmailer' => '<a href="'.$faqSystem->getSystemUri($faqConfig).'phpmailer.html">'.$PMF_LANG['phpmailer'].'</a>',
        //'phpmailer' => '<a href="http://localhost/phpmyfaq/temp/mail_form.html">'.$PMF_LANG['phpmailer'].'</a>',
        'opensearch' => $faqSystem->getSystemUri($faqConfig).'opensearch.html', );
} else {
    $tplNavigation = array(
        'first' => '<a href="http://localhost/phpmyfaq/">'.$PMF_LANG['first'].'</a>',
        ...
        'msgContact' => '<a href="index.php?'.$sids.'action=contact" target="_blank">'.$PMF_LANG['msgContact'].'</a>',
        ...
        //'phpmailer' => '<a href="index.php?'.$sids.'action=phpmailer">'.$PMF_LANG['phpmailer'].'</a>',
        //'phpmailer' => '<a href="http://localhost/phpmyfaq/temp/mail_form.php" target="_blank">'.$PMF_LANG['phpmailer'].'</a>',
