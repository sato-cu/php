...
$PMF_LANG['first'] = 'はじめに';
$PMF_LANG['phpmailer'] = '担当者へ直接問い合わせる';
...
$PMF_LANG['msgShowAllCategories'] = 'FAQｶﾃｺﾞﾘ別';
$PMF_LANG['msgSearch'] = '検索';
$PMF_LANG['msgAddContent'] = 'FAQの登録';
$PMF_LANG['msgQuestion'] = '質問の登録';
$PMF_LANG['msgOpenQuestions'] = 'FAQ Overview';
$PMF_LANG['msgHelp'] = 'ヘルプ';
$PMF_LANG['msgContact'] = '問い合わせ';
$PMF_LANG['msgHome'] = 'FAQ ホーム';
$PMF_LANG['msgNews'] = '';
$PMF_LANG['msgUserOnline'] = 'ユーザがオンライン';
$PMF_LANG['msgBack2Home'] = 'メイン ページに戻る';
$PMF_LANG['msgFullCategories'] = '登録されている全FAQ 【カテゴリ別 一覧表示】';
...
$PMF_LANG['msgVoteUseability'] = 'この FAQ の評価';
...
$PMF_LANG['msgVoteThanks'] = '評価ありがとうございます';
$PMF_LANG['msgYouCan'] = '';
$PMF_LANG['msgWriteComment'] = '==============追加でコメントする（コメント欄を開く▼）';
$PMF_LANG['msgShowCategory'] = '内容の概要: ';
$PMF_LANG['msgCommentBy'] = 'コメント作成は';
$PMF_LANG['msgCommentHeader'] = 'コメントを書く';
$PMF_LANG['msgYourComment'] = 'コメント:';
$PMF_LANG['msgCommentThanks'] = 'コメントが登録されました。画面を更新（F5）してください。';
...
$PMF_LANG['msgNewContentHeader'] = '新しい FAQ を登録する';
$PMF_LANG['msgNewContentAddon'] = '以下からも登録できます。(管理者の承認後に登録されます)';
$PMF_LANG['msgNewContentName'] = '名前:';
$PMF_LANG['msgNewContentMail'] = 'mail:';
$PMF_LANG['msgNewContentCategory'] = 'カテゴリ:';
...
$PMF_LANG['msgNewContentSubmit'] = '登録';
$PMF_LANG['msgInfo'] = '追加情報: ';
$PMF_LANG['msgNewContentThanks'] = '登録を受け付けました';
$PMF_LANG['msgNoQuestionsAvailable'] = '現在処理すべき質問がありません。';
$PMF_LANG['msgNewQuestion'] = '○○検索にないFAQは質問の登録をお願いします○○';
$PMF_LANG['msgAskCategory'] = 'カテゴリ:';
$PMF_LANG['msgAskYourQuestion'] = '質問:';
$PMF_LANG['msgAskThx4Mail'] = '<h2>質問を受け付けました。担当者からの回答をお待ちください。</h2>';
$PMF_LANG['msgDate_User'] = '日付 / ユーザ';
$PMF_LANG['msgQuestion2'] = '質問';
$PMF_LANG['msg2answer'] = '回答';
$PMF_LANG['msgQuestionText'] = '他のユーザが質問した内容を確認することができます。質問に答えた場合、管理者の確認後、FAQに追加されます。';
$PMF_LANG['msgHelpText'] = 'このFAQ (<strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions) の利用方法が簡単です。<strong><a href="?action=show">カテゴリ</a></strong> から関連内容を項目別に探すか <strong><a href="?action=search">検索</a></strong> からキーワードを入力して探すことができます。';
$PMF_LANG['msgContactEMail'] = '管理者に電子メール:';
$PMF_LANG['msgMessage'] = 'メッセージ:';
$PMF_LANG['msgTopTen'] = 'アクセスの多いFAQ &nbsp;&nbsp; TOP10';
$PMF_LANG['msgHomeThereAre'] = '合計 ';
$PMF_LANG['msgHomeArticlesOnline'] = ' 個の FAQ があります。';
$PMF_LANG['msgNoNews'] = '新しいお知らせはありません。';
$PMF_LANG['msgLatestArticles'] = '最近UPされたFAQ &nbsp;&nbsp; TOP10';
...
$PMF_LANG['err_noArticles'] = '登録されている FAQ がありません。回答が必要な場合は新規に質問してください。';
$PMF_LANG['err_badID'] = '間違った ID です。';
$PMF_LANG['err_noTopTen'] = '人気の FAQ がまだ利用できません。';
$PMF_LANG['err_nothingFound'] = 'エントリが見つかりません。';
...
$PMF_LANG['err_VoteTooMuch'] = '複数回の評価はできません。F5をクリックしてください。';
...
$PMF_LANG['ad'] = '管理者ページ';
$PMF_LANG['ad_menu_user_administration'] = 'ユーザ';
...
$PMF_LANG['ad_adus_adduser'] = 'ユーザの追加';
$PMF_LANG['ad_adus_name'] = 'ID:';
$PMF_LANG['ad_adus_password'] = 'パスワード:';
$PMF_LANG['ad_adus_add'] = 'ユーザ追加';
$PMF_LANG['ad_adus_suc'] = 'ユーザの追加に<strong>成功</strong>しました。';
$PMF_LANG['ad_adus_edit'] = 'プロフィールの変更';
$PMF_LANG['ad_adus_dberr'] = '<strong>データベースエラーです!</strong>';
$PMF_LANG['ad_adus_exerr'] = 'ユーザは既に<strong>存在します</strong>。';
...
$PMF_LANG['ad_rs_rating_2'] = 'ランクのユーザを見る:';
...
$PMF_LANG['ad_log_edit'] = '-次のユーザの「ユーザ編集」フォーム: ';
$PMF_LANG['ad_log_crea'] = '「新規記事」フォーム.';
$PMF_LANG['ad_log_crsa'] = '新規エントリを作成しました。';
$PMF_LANG['ad_log_ussa'] = '次のユーザのデータを更新しました: ';
$PMF_LANG['ad_log_usde'] = '次のユーザを削除しました: ';
$PMF_LANG['ad_log_beed'] = '次のユーザの変更フォーム: ';
$PMF_LANG['ad_log_bede'] = '次のエントリを削除: ';
$PMF_LANG['ad_start_visits'] = '訪問数';
$PMF_LANG['ad_start_articles'] = '記事数';
$PMF_LANG['ad_start_comments'] = 'コメント';
...
$PMF_LANG['rightsLanguage']['adduser'] = 'ユーザの追加';
$PMF_LANG['rightsLanguage']['edituser'] = 'ユーザの編集';
$PMF_LANG['rightsLanguage']['deluser'] = 'ユーザの削除';
...
$PMF_LANG['msgWriteNoComment'] = '※このFAQは回答されていないため、まだ追加のコメントができません。';
...
$LANG_CONF['records.disableAttachments'] = array(0 => 'checkbox', 1 => 'エントリの下に添付のリンクを表示する');
...
$PMF_LANG['lostpwd_err_1'] = 'エラー: ユーザ名と電子メールアドレスが見つかりません。';
...
$PMF_LANG['msgSitemap'] = 'サイトマップ&nbsp;&nbsp;(ローマ字順,&nbsp;あいうえお順)';
...
$PMF_LANG['msgAdvancedSearch'] = 'FAQを検索';
$PMF_LANG['spamControlCenter'] = 'スパム制御センター';
$LANG_CONF['spam.enableSafeEmail'] = array(0 => "checkbox", 1 => "安全にユーザの電子メールを表示する (初期値: 有効)");
...
$PMF_LANG['ad_user_error_loginInvalid'] = '指定されたユーザIDは無効です。';
$PMF_LANG['ad_user_error_noEmail'] = '有効なメールアドレスを入力してください。';
$PMF_LANG['ad_user_error_noRealName'] = '本名を入力してください。';
$PMF_LANG['ad_user_error_delete'] = 'ユーザアカウントを削除できませんでした。';
$PMF_LANG['ad_user_error_noId'] = 'ID を指定していません。';
$PMF_LANG['ad_user_error_protectedAccount'] = 'このユーザは保護されています。';
$PMF_LANG['ad_user_deleteUser'] = 'ユーザの削除';
...
$PMF_LANG['admin_mainmenu_users'] = 'ユーザ';
...
$PMF_LANG['ad_entry_tags'] = 'タグ一覧';
$PMF_LANG['msg_tags'] = 'タグ一覧';
...
$PMF_LANG['msg_related_articles'] = '==============関連カテゴリ（カテゴリを開く▼）';
...
$PMF_LANG['ad_categ_translatecateg'] = 'カテゴリの翻訳';
$PMF_LANG['ad_categ_translate'] = '翻訳';
$PMF_LANG['ad_categ_transalready'] = '翻訳済みカテゴリ: ';
...
$PMF_LANG['ad_menu_categ_structure'] = '言語を含むカテゴリ概要';
$PMF_LANG['ad_entry_userpermission'] = 'ユーザ権限:';
$PMF_LANG['ad_entry_grouppermission'] = 'グループ権限:';
$PMF_LANG['ad_entry_all_users'] = 'すべてのユーザのアクセス';
...
$PMF_LANG['ad_categ_paste2'] = '次のカテゴリ配下に貼り付け';
...
$PMF_LANG['ad_quick_user'] = '新規ユーザの追加';
...
$PMF_LANG['msgTagSearch'] = 'タグ付けされているエントリ（FAQの編集 （Admin）画面よりタグ付けをすることで有効になります）';
...
$PMF_LANG['msgUserData'] = '登録にはユーザ情報が必要です';
...
$PMF_LANG['emailRegSubject'] = '[%sitename%] 登録: 新規ユーザ';
$PMF_LANG['msgMostPopularSearches'] = 'アクセスの多い検索ワード&nbsp;&nbsp;一覧:';
...
$PMF_LANG['ad_sess_noentry'] = 'エントリがありません';
...
$PMF_LANG['plmsgSearchAmount']['1'] = '%d 件の検索結果&nbsp;&nbsp;(確認したい内容はありますか？)';
...
$PMF_LANG['list_all_users'] = '全ユーザの一覧';
$PMF_LANG['main.orderingPopularFaqs.visits'] = '最も訪問があるエントリの一覧';
$PMF_LANG['main.orderingPopularFaqs.voting'] = '最も投票のあるエントリの一覧';
...
$PMF_LANG['ad_stat_report_category'] = 'カテゴリ';
$PMF_LANG['ad_stat_report_sub_category'] = 'サブカテゴリ';
...
$PMF_LANG['headerUserControlPanel'] = 'ユーザ情報の編集';
